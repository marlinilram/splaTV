...
const vertexShaderSource = `
  ...
  void main () {
      ...
      vec4 cam = view * vec4(uintBitsToFloat(static0.xyz), 1);
...
async function initXR() {
  ...
  const url = params.get("url") ? new URL(params.get("url"), "https://huggingface.co/cakewalk/splat-data/resolve/main/") : "model_frame_0.splatv";
